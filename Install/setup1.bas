...
'Global Variables
'
Global gbInstallSampleDB As Boolean
...
Dim dbsTour As Database
Dim SQL As String


Set dbsTour = DBEngine.Workspaces(0).OpenDatabase(gDirectory & "TourWin.mdb", False, False, ";pwd=Tourwin")
If dbsTour Is Nothing Then Exit Function
' ------------------
' Define SearcherDB
' ------------------
SQL = "Update UserTbl " & _
      "Set Name = '" & gFirstName & "', " & _
      "DataPath = '" & gDirectory & "' " & _
      "WHERE ID = 1"
Debug.Print SQL
dbsTour.Execute SQL
dbsTour.Close
