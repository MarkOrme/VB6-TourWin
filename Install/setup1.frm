...
'
    ...
    ' setup.
    '
    Open App.Path & "\setup1.txt" For Output As #1
        Print #1, Command$
    Close #1
    ...
    '
    ' Copy sample DB is selected
'    If gbInstallSampleDB = True Then
'        CopySection "Samples"
'    End If
'    '
    ' Update TourWin.mdb with user Info
    ' ==================================
'    UpdateTourUser_UserTbl
